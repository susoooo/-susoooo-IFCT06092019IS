...
printf("\n Hola soy el programa edificio diseñado para almacenar y calcular el numero de habitantes de cada vivienda\n\n");
...
for(cont1=0;cont1<6;cont1++)	
	...
	piso=0;
		...
		printf("El piso con mas habitantes es el %dº y tiene = %d\n\n",planta,mayor);
		return(0);
