...
int main( )
{
printf("\n   - Hola soy el programa CALCU+ pro. diseñado por Nestor Rois para hacer calculos matematicos - \n");
...
do
   {
	...
	printf("\n          POR FAVOR INDIQUE QUE OPERACION QUIERE REALIZAR \n");
		...
		printf("Introduzca 0 Si no desea realizar mas calculos\n",numero1);
		scanf("%d",&seleccion);
...
printf("\n                        GRACIAS POR USAR EL PROGRAMA CALCU+ pro.\n\n");
    }	